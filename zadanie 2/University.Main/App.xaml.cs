...
namespace University.Main
{
    public partial class App : Application
    {
        ...
        private void ConfigureServices(ServiceCollection serviceCollection)
        {
            ...
            serviceCollection.AddSingleton<IDataAccessService, DataAccessService>(x => new DataAccessService(serviceCollection.BuildServiceProvider().GetService<UniversityContext>()));

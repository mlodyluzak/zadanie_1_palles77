    ...
    public class UniversityContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Student>().HasData(
                new Student { StudentId = 1, Name = "Wieczysław", LastName = "Nowakowicz", PESEL = "87052225382", BirthDate = new DateTime(1987, 05, 22), BirthPlace = "Warszawa", AddressLine1 = "ul. Długa 1", AddressLine2 = "", ResidencePlace = "Warszawa", Courses = new List<Course>() },
                new Student { StudentId = 2, Name = "Stanisław", LastName = "Nowakowicz", PESEL = "16262565313", BirthDate = new DateTime(2016, 06, 25), BirthPlace = "Wrocław", AddressLine1 = "ul. Krótka 20", AddressLine2 = "", ResidencePlace = "Kraków", Courses = new List<Course>() },
                new Student { StudentId = 3, Name = "Eugenia", LastName = "Nowakowicz", PESEL = "21260822216", BirthDate = new DateTime(2021, 06, 08), BirthPlace = "Poznań", AddressLine1 = "ul. Kolorowa 8", AddressLine2 = "", ResidencePlace = "Gdanśk", Courses = new List<Course>() });

            modelBuilder.Entity<Course>().HasData(
                new Course { CourseCode = "MAT", Title = "Matematyka", Instructor = "Michalina Warszawa", Schedule = "schedule1", Description = "description1", Credits = 5, Department = "department1" },
